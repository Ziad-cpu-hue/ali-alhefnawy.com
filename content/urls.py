...
urlpatterns = [
    ...
    # --- خرائط ثابتة للثانوي ---
    path("first/", views.course_list, {'grade': '1'}, name='course_first'),
    path("second/", views.course_list, {'grade': '2'}, name='course_second'),
    path("third/", views.course_list, {'grade': '3'}, name='course_third'),

    # --- خرائط ثابتة للإعدادي (منفصلة تمامًا عن الثانوي) ---
    path("prep-first/", views.course_list, {'grade': '4'}, name='course_prep_first'),
    path("prep-second/", views.course_list, {'grade': '5'}, name='course_prep_second'),
    path("prep-third/", views.course_list, {'grade': '6'}, name='course_prep_third'),

    # مسارات المحتوى والتفاصيل
